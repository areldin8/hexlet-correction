...
To enable VK ID authorization, you need to register on [VK ID OAuth](https://oauth2.vk.com/) and create your web application,
add `ClientID` and `Client secret` in your secret

```bash
VK_CLIENT_ID=your_yadex_client_id_values
VK_CLIENT_SECRET=your_yandex_client_secret_values
````
